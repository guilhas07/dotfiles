...
function M.on_attach(client, bufnr)
	...
	vim.keymap.set("n", "<leader>]d", function()
		...
		-- NOTE: CursorMoved event triggers after float is opened, closing the window https://github.com/neovim/neovim/issues/12923.
		-- Use vim.defer_fn so the event is processed before opening the diagnostic window.
